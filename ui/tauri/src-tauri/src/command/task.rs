...
use make_progress_core::{
    prelude::{TaskParams, TaskService},
    Service,
};
use tauri::State;

#[tauri::command]
pub async fn create_task(service: State<'_, Service>) -> TauriResult<()> {
...
#[tauri::command]
pub async fn get_task_list(service: State<'_, Service>, params: TaskParams) -> TauriResult<()> {
